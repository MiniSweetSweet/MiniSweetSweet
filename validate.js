...
var formUrl = "http://www.artecasauae.com/gallery/js/php/validate.php?value=";
...
{
	//alert('send');
	http.open("POST", "http://www.artecasauae.com/gallery/js/php/validate.php");
...
function handleHttpResponse() {
	...
	if(http.readyState == 4) {
		...
		if(http.responseText == "false") {
			...
			document[formId].src = "no.png"/*tpa=http://www.artecasauae.com/gallery/js/img/no.png*/;
			...
			document[formId].src = "yes.png"/*tpa=http://www.artecasauae.com/gallery/js/img/yes.png*/;
			...
			document[formId].src = "blank-1.png"/*tpa=http://www.artecasauae.com/gallery/js/img/blank.png*/;
			...
			if( ( http.responseText ).indexOf( 'class="success' ) > -1 ) {
				...
				$('input:not([type=submit]):not([type=button]):not([type=hidden])').each(
					function()
					{
						...
						document[f_name].src =  "blank-1.png"/*tpa=http://www.artecasauae.com/gallery/js/img/blank.png*/;
					}
				);
				$('textarea').each(
					function()
